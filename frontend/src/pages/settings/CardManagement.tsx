// path: main/frontend/src/pages/settings/CardManagement.tsx
...
function SchemeDetailManager({
  ...
  const [schemeDetails, setSchemeDetails] = useState<{
    ...
    rewards: Array<{
      ...
      quota_calculation_basis?: string; // 新增欄位
      display_order: number;
    }>;
  } | null>(null);
                ...
                <table className="min-w-full text-xs text-gray-700">
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      <th className="px-2 py-1 text-left font-semibold text-gray-600">方式</th>
                      <th className="px-2 py-1 text-left font-semibold text-gray-600">基準</th>
                      <th className="px-2 py-1 text-left font-semibold text-gray-600">上限</th>
                      <th className="px-2 py-1 text-left font-semibold text-gray-600">刷新</th>
                    </tr>
                  </thead>
                  <tbody>
    ...
    <div className="p-3 bg-gray-50 rounded border">
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 mb-2">
        ...
        <div className="flex gap-2 flex-wrap">
          <button onClick={() => { setShowSchemes(!showSchemes); if (!showSchemes) loadSchemes(); }} className="px-3 py-1 bg-blue-500 text-white rounded text-sm hover:bg-blue-600">
